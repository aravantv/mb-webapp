...
type alias Parameters subModel1 msg1 factoryInput1 subModel2 msg2 factoryInput2 =
    ( Widget subModel1 msg1 factoryInput1, PathTransformer, Widget subModel2 msg2 factoryInput2, PathTransformer )
...
emptyModel ( wrappedWidget1, _, wrappedWidget2, _ ) =
...
update params msg model path =
    let
        ( wrappedWidget1, pathAdapter1, wrappedWidget2, pathAdapter2 ) =
            params
    in
        case msg of
...
subscriptions ( wrappedWidget1, pathAdapter1, wrappedWidget2, pathAdapter2 ) model path =
    let
        sub1 =
...
view ( wrappedWidget1, _, wrappedWidget2, _ ) model =
    div []
